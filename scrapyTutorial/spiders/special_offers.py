...
class SpecialOffersSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://web.archive.org/web/20190225123327/https://www.tinydeal.com/specials.html', callback=self.parse, headers={
            'User-Agent': 'https://web.archive.org/web/20190225123327/https://www.tinydeal.com/specials.html'
        })
    ...
    def parse(self, response):
        ...
        if next_page:
            yield scrapy.Request(response.urljoin(next_page), callback=self.parse, headers={
                'User-Agent': 'https://web.archive.org/web/20190225123327/https://www.tinydeal.com/specials.html'
            })
